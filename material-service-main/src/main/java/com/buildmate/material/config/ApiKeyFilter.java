...
/**
 * Centralized API-key validation (Supplier Service pattern).
 * Validates {@code X-API-KEY} against MongoDB {@code api_keys} (active keys),
 * with optional env fallback {@code MATERIAL_API_KEY} / {@code material.api-key.default}.
 * Registered only via {@link SecurityConfig} (not as a servlet {@code @Component}) to avoid duplicate filters.
 */
public class ApiKeyFilter extends OncePerRequestFilter {
    ...
    @Value("${material.api-key.default:}")
